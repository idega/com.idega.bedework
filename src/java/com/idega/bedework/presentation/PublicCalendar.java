/**
 * @(#)PublicCalendar.java    1.0.0 8:52:19 AM
 *
...
/**
 * <p>Class for demonstrating and testing Bedework calendar integration.</p>
 * <p>You can report about problems to: 
 * <a href="mailto:martynas@idega.com">Martynas Stakė</a></p>
 * <p>You can expect to find some test cases notice in the end of the file.</p>
 *
 * @version 1.0.0 Apr 3, 2012
 * @author martynasstake
 */
public class PublicCalendar extends Block {
	...
	public void main(IWContext iwc) throws Exception {
		...
		BwCalendar bwcal = new BwCalendar();
		bwcal.setName("Pirmas_kalendorius");
		...
		BwCalendar publicCalendars = calendarHandler.getPublicCalendars();
		System.out.println(publicCalendars.getName());
		calendarSuiteAPI.close();
	}
