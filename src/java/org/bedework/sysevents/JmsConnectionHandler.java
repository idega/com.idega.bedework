...
private boolean debug;
  ...
  private static final String propertiesFile = BedeworkConstants.FILE_PATH_SYSEVENTS_PROPERTIES;
...
//					((org.apache.activemq.ActiveMQConnection)connection).getDestinationSource();
        ...
        //FIXME think about correct solution later
        ourQueue = session.createQueue(pr.getProperty("org.bedework.jms.queue.prefix") +
                                      queueName);
